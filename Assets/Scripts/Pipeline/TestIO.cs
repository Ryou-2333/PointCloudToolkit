...
namespace PCToolkit.Pipeline
{
    public class TestIO : MonoBehaviour
    {
        ...
        public IEnumerator GeneratePointCloud()
        {
            ...
            yield return mvc.CaptureParameters(target, mvis);
        ...
        public IEnumerator GenerateParamImages()
        {
            ...
            yield return mvc.CaptureParameters(target, imageSet);
            ...
            {
                byte[] bytes = imageSet.imageSets[i].albedo.EncodeToPNG();
        ...
        public void Start()
        {
            StartCoroutine(GenerateRawImages());
        }
    }
}
